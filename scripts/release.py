...
AUTHOR_MAP = {
    ...
    "shannon@callmemo.ai": "shannonsands",
    ...
    "clement@callmemo.ai": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"anakot-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "anakot@callmemo.ai"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/Chensihakniroth/ANAKOT-AGENT",
...
def main():
    ...
    print(f"{'='*60}")
    print(f"  Anakot Agent Release Preview")
    print(f"{'='*60}")
