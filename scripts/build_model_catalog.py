...
from anakot_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "providers": {
            ...
            "nous": {
                "metadata": {
                    "display_name": "callmemo Portal",
                    "note": (
                        "Free-tier gating is determined live via Portal pricing "
                        "(partition_callmemo_models_by_tier), not this manifest."
                    ),
                },
                "models": [
                    {"id": mid}
