...
const IMAGE_CACHE_DIR = path.join(process.env.HOME || '~', '.anakot', 'image_cache');
const DOCUMENT_CACHE_DIR = path.join(process.env.HOME || '~', '.anakot', 'document_cache');
const AUDIO_CACHE_DIR = path.join(process.env.HOME || '~', '.anakot', 'audio_cache');
