...
Environment:
    ...
    ANAKOT_TEST_PATHS    Override discovery roots (colon-sep, default: 'tests')
...
def _format_file(file: Path, repo_root: Path) -> str:
    ...
    ``/home/runner/work/anakot-agent/anakot-agent/tests/acp/test_auth.py``.
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Default: 600 (10 min), env: ANAKOT_TEST_FILE_TIMEOUT."
        ),
    )
    parser.add_argument(
        "--slice",
