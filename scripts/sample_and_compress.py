...
DEFAULT_DATASETS = [
    "callmemo/swe-terminus-agent-glm-kimi-minimax",
    "callmemo/anakot-agent-megascience-sft1",
    "callmemo/Anakot-Agent-Thinking-GLM-4.7-SFT2",
    "callmemo/Anakot-Agent-Thinking-GLM-4.7-SFT1",
    "callmemo/terminal-tasks-glm-anakot-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "callmemo/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload callmemo/{output_name} {final_output}")
