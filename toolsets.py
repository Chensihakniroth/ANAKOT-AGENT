...
_ANAKOT_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (ANAKOT_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `anakot tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (ANAKOT_KANBAN_TASK env "
    ...
    # ==========================================================================
    # Full Anakot toolsets (CLI + messaging platforms)
    #
    ...
    "anakot-cron": {
        # Mirrors anakot-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `anakot tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as anakot-cli; gated by `anakot tools`",
        "tools": _ANAKOT_CORE_TOOLS,
        "includes": []
    },
    ...
    "anakot-email": {
        "description": "Email bot toolset - interact with Anakot via email (IMAP/SMTP)",
        "tools": _ANAKOT_CORE_TOOLS,
        "includes": []
    },
    ...
    "anakot-sms": {
        "description": "SMS bot toolset - interact with Anakot via SMS (Twilio)",
        "tools": _ANAKOT_CORE_TOOLS,
        "includes": []
    },
    ...
    "anakot-webhook": {
        ...
        "tools": _ANAKOT_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
    ...
    "anakot-gateway": {
        ...
        "tools": [],
        "includes": ["anakot-telegram", "anakot-discord", "anakot-whatsapp", "anakot-slack", "anakot-signal", "anakot-bluebubbles", "anakot-homeassistant", "anakot-email", "anakot-sms", "anakot-mattermost", "anakot-matrix", "anakot-dingtalk", "anakot-feishu", "anakot-wecom", "anakot-wecom-callback", "anakot-weixin", "anakot-qqbot", "anakot-webhook", "anakot-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (anakot-<name>).
        # Gives them _ANAKOT_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("anakot-"):
            platform_name = name[len("anakot-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_ANAKOT_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
