...
Report privately via [GitHub Security Advisories](https://github.com/callmemo/anakot-agent/security/advisories/new)
or **security@callmemo.ai**. Do not open public issues for
