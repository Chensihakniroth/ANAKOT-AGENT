# Anakot Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.anakot/plugins/anakot-achievements/state.json` (existing unlock state)
  - `~/.anakot/plugins/anakot-achievements/scan_snapshot.json` (new)
  - `~/.anakot/plugins/anakot-achievements/scan_checkpoint.json` (new)
