# Anakot Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.anakot/plugins/anakot-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.anakot/plugins/anakot-achievements/scan_checkpoint.json`.
