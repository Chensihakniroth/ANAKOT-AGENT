...
def _read_dm_role_auth_guild() -> Optional[int]:
    ...
    policy, ``~/.anakot/.env`` is for secrets only, and this is a
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("ANAKOT_DISCORD_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("ANAKOT_DISCORD_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Anakot session")
        ...
        @tree.command(name="status", description="Show Anakot session status")
        ...
        @tree.command(name="stop", description="Stop the running Anakot agent")
        ...
        @tree.command(name="reload-skills", description="Re-scan ~/.anakot/skills/ for new or removed skills")
        ...
        @tree.command(name="update", description="Update Anakot Agent to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the Anakot gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Anakot session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Anakot in the thread",
        ...
        # anakot_cli/commands.py automatically appear as Discord slash
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        try:
            ...
            cmd = discord.app_commands.Command(
                name="skill",
                description="Run a Anakot skill",
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from anakot_cli.commands import discord_skill_commands_by_category
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Anakot session in the thread
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        try:
            ...
            try:
                seed_msg = await message.channel.send(f"\U0001f9f5 Thread created by Anakot: **{thread_name}**")
                thread = await seed_msg.create_thread(
                    name=thread_name,
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``anakot update --gateway``
...
def _define_discord_view_classes() -> None:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``anakot update`` prompts.
...
# is not in this process (e.g. ``anakot cron`` running standalone) and no live
...
def _is_connected(config) -> bool:
    ...
    Looks up via ``anakot_cli.gateway.get_env_value`` at call time (not via
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install 'anakot-agent[messaging]'",
        # Interactive setup wizard — replaces the central
        # anakot_cli/setup.py::_setup_discord function.  Same shape as Teams.
