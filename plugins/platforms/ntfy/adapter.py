"""ntfy platform adapter (Anakot plugin).
...
``plugins/platforms/ntfy/``. The Anakot plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "anakot-in"              # subscribe topic (incoming)
          publish_topic: "anakot-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``anakot cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Anakot dependency",
