...
required — uses aiohttp which is already a Anakot dependency.
...
def interactive_setup() -> None:
    ...
    ``anakot_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Anakot delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # anakot_cli/setup.py::_setup_mattermost function.
