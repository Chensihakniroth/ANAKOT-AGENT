...
def _load_supermemory_config(anakot_home: str) -> dict:
...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        # Only prompt for the API key during `anakot memory setup`.
        # All other options are documented for $ANAKOT_HOME/supermemory.json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._turn_count = 0
        self._config = _load_supermemory_config(self._anakot_home)
