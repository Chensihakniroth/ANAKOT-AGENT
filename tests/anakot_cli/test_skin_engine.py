...
class TestSkinConfig:
    ...
    def test_get_color_with_fallback(self):
        from anakot_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_color("banner_title") == "#ff70a6"
...
class TestBuiltinSkins:
    ...
    def test_all_builtin_skins_have_complete_colors(self):
        from anakot_cli.skin_engine import _BUILTIN_SKINS, _build_skin_config
...
class TestSkinManagement:
    ...
    def test_init_skin_from_config(self):
        from anakot_cli.skin_engine import init_skin_from_config, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        assert skin.get_color("banner_border") == "#bc93ff"  # from default
...
class TestCliBrandingHelpers:
    ...
    def test_active_prompt_symbol_ares(self):
        from anakot_cli.skin_engine import set_active_skin, get_active_prompt_symbol

        set_active_skin("ares")
        assert get_active_prompt_symbol() == "⚔ "

    def test_active_help_header_ares(self):
        from anakot_cli.skin_engine import set_active_skin, get_active_help_header
