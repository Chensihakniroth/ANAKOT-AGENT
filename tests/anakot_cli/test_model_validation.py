...
class TestParseModelInput:
    ...
    def test_nous_provider_switch(self):
        provider, model = parse_model_input("nous:anakot-3", "openrouter")
        assert provider == "nous"
        assert model == "anakot-3"
...
class TestProviderModelIds:
    ...
    def test_copilot_prefers_live_catalog(self):
        with patch("anakot_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "gh-token"}), \
             patch("anakot_cli.models._fetch_github_models", return_value=["gpt-5.4", "claude-sonnet-4.6"]):
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch("anakot_cli.models.urllib.request.urlopen", side_effect=Exception("timeout")):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("anakot_cli.models.urllib.request.urlopen", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("anakot_cli.models.urllib.request.urlopen", return_value=_Resp()) as mock_urlopen:
...
class TestValidateApiFallback:
    ...
    def test_unknown_provider_soft_accepted_when_api_down(self):
        ...
        with patch("anakot_cli.models.provider_model_ids", return_value=[]):
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("anakot_cli.models.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("anakot_cli.models.urllib.request.urlopen", side_effect=http_error):
    ...
    def test_fetch_lmstudio_models_returns_empty_on_network_error(self):
        with patch(
            "anakot_cli.models.urllib.request.urlopen",
