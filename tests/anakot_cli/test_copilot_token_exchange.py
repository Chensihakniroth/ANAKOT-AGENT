...
class TestExchangeCopilotToken:
    ...
    def test_refreshes_expired_cache(self, mock_urlopen):
        from anakot_cli.copilot_auth import exchange_copilot_token, _jwt_cache, _token_fingerprint
...
class TestGetCopilotApiToken:
    ...
    @patch("anakot_cli.copilot_auth.exchange_copilot_token", side_effect=ValueError("fail"))
...
class TestCallerIntegration:
    ...
    @patch("anakot_cli.copilot_auth.get_copilot_api_token", return_value="exchanged_jwt")
