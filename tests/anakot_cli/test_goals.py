...
class TestGoalManager:
    def test_no_goal_initial(self, anakot_home):
    ...
    def test_set_rejects_empty(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_clear(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, anakot_home):
    ...
    def test_evaluate_after_turn_done(self, anakot_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, anakot_home):
        from anakot_cli import goals
        from anakot_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, anakot_home):
    ...
    def test_evaluate_after_turn_inactive(self, anakot_home):
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, anakot_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, anakot_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from anakot_cli import goals
        from anakot_cli.goals import GoalManager, load_goal
...
class TestGoalManagerSubgoals:
    ...
    def test_add_subgoal_requires_active_goal(self, anakot_home):
        import pytest
        from anakot_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, anakot_home):
        import pytest
        from anakot_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, anakot_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, anakot_home):
        from anakot_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, anakot_home):
        from anakot_cli.goals import GoalManager
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, anakot_home):
        from anakot_cli.goals import GoalManager
