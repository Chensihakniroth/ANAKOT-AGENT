...
# =============================================================================
# OpenRouter / callmemo Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndNous:
    """tencent/hy3-preview:free and tencent/hy3-preview should appear in OpenRouter and callmemo curated lists."""

    def test_in_openrouter_fallback(self):
        from anakot_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubDoctor:
    """Verify anakot doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``anakot model`` routes it through the generic api_key_provider flow.
        """
        import inspect
