...
def test_switch_model_accepts_explicit_named_custom_provider(monkeypatch):
    ...
    monkeypatch.setattr("anakot_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("anakot_cli.models.fetch_lmstudio_models", _fake_fetch)
