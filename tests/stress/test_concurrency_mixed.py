...
def worker_loop(worker_id: int, anakot_home: str, result_file: str) -> None:
...
def reclaimer_loop(anakot_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="anakot_mixed_stress_")
    print(f"ANAKOT_HOME = {home}")
