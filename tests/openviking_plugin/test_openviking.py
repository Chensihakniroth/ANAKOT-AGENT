...
class TestOpenVikingRead:
        ...
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/content/read",
                    (("uri", "viking://user/anakot/memories/profile.md"),),
                ): {"result": "full text"},
            }
        )

        result = json.loads(provider._tool_read({"uri": "viking://user/anakot/memories/profile.md", "level": "full"}))

        assert result["uri"] == "viking://user/anakot/memories/profile.md"
        assert result["resolved_uri"] == "viking://user/anakot/memories/profile.md"
    ...
    def test_overview_file_uri_routes_straight_to_content_read_via_stat_probe(self):
        ...
        provider = OpenVikingMemoryProvider()
        file_uri = "viking://user/anakot/memories/entities/mem_abc.md"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
    ...
    def test_overview_directory_uri_uses_stat_probe_then_overview(self):
        ...
        provider = OpenVikingMemoryProvider()
        dir_uri = "viking://user/anakot/memories"
        provider._client = FakeVikingClient(
            {
                (
                    "/api/v1/fs/stat",
