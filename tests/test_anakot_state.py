...
from anakot_state import SCHEMA_SQL, SessionDB
...
class TestSessionLifecycle:
    ...
    def test_db_initializes_without_fts5_module(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("anakot_state.sqlite3.connect", connect_without_fts)
    ...
    def test_fts_runtime_restores_triggers_after_no_fts_open(
        ...
        monkeypatch.setattr("anakot_state.sqlite3.connect", real_connect)
...
class TestSchemaInit:
    ...
    def test_schema_version(self, db):
        from anakot_state import SCHEMA_VERSION
    ...
    def test_topic_mode_schema_is_not_auto_migrated_on_open(self, tmp_path):
        ...
        The gateway must remain rollback-safe: simply upgrading Anakot and starting
    ...
    def test_schema_sql_is_source_of_truth(self, db):
        ...
        """
        from anakot_state import SCHEMA_SQL
