...
class TestCLIStatusBar:
    ...
    def test_input_height_counts_wide_characters_using_cell_width(self):
        ...
        with patch.object(AnakotCLI, "_get_tui_prompt_text", return_value="❯ "), \
    ...
    def test_scrollback_box_width_returns_viewport_width(self):
        ...
        assert AnakotCLI._scrollback_box_width(20) == 32
        assert AnakotCLI._scrollback_box_width(32) == 32
        # Above the floor, return the actual viewport width — no cap.
        assert AnakotCLI._scrollback_box_width(48) == 48
        assert AnakotCLI._scrollback_box_width(80) == 80
        assert AnakotCLI._scrollback_box_width(120) == 120
        assert AnakotCLI._scrollback_box_width(200) == 200
