...
class TestInterruptAutoPause:
    def test_interrupted_turn_pauses_goal_and_skips_continuation(self, anakot_home):
        ...
        with patch("anakot_cli.goals.judge_goal") as judge_mock:
...
class TestEmptyResponseSkip:
    def test_empty_response_does_not_invoke_judge(self, anakot_home):
    ...
    def test_no_assistant_message_skipped(self, anakot_home):
