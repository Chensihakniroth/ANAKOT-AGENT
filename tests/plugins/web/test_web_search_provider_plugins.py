...
class TestErrorResponseShapes:
    ...
    def test_firecrawl_config_error_points_paid_users_to_callmemo_subscription(self, monkeypatch):
        from plugins.web.firecrawl import provider as firecrawl_provider

        monkeypatch.setattr(
            "tools.web_tools.managed_callmemo_tools_enabled",
            lambda: True,
            raising=False,
        )
        ...
        assert "With your callmemo subscription you can also use the Tool Gateway" in message
        assert "select callmemo Subscription as the web provider" in message
