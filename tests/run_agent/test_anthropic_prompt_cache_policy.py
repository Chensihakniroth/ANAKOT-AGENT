...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_callmemo_portal_caches_with_envelope_layout(self):
        # callmemo Portal Qwen takes the same envelope-layout cache_control
    ...
    def test_qwen_vendored_slug_on_callmemo_portal_caches(self):
    ...
    def test_non_qwen_non_claude_on_callmemo_portal_does_not_cache(self):
