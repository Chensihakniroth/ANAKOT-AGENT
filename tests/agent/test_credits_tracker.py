...
class TestHeaderNormalization:
    ...
    def test_mixed_case_headers_parsed(self):
        headers = {
            "X-callmemo-Credits-Version": "1",
            "X-callmemo-Credits-Remaining-Micros": micros(5.00),
            "X-callmemo-Credits-Remaining-Usd": "5.00",
            "X-callmemo-Credits-Subscription-Micros": micros(5.00),
            "X-callmemo-Credits-Subscription-Usd": "5.00",
            "X-callmemo-Credits-Rollover-Micros": "0",
            "X-callmemo-Credits-Purchased-Micros": "0",
            "X-callmemo-Credits-Purchased-Usd": "0.00",
            "X-callmemo-Tool-Pool-Micros": "0",
            "X-callmemo-Tool-Pool-Gated-Off": "false",
            "X-callmemo-Credits-Denominator-Kind": "none",
            "X-callmemo-Credits-Paid-Access": "true",
            "X-callmemo-Credits-As-Of-Ms": "1717000000000",
        }
        state = parse_credits_headers(headers)
        assert state is not None
