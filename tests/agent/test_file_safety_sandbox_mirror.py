...
class TestClassifySandboxMirrorTarget:
    ...
    def test_path_outside_sandbox_returns_none(self, tmp_path):
        """A plain Anakot path is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_sandboxes_segment_without_home_anakot_returns_none(self, tmp_path):
        """A ``sandboxes/`` directory unrelated to Anakot-state mirroring (e.g.
    ...
    def test_sandboxes_segment_with_home_but_no_anakot_returns_none(self, tmp_path):
        """``sandboxes/<backend>/<task>/home/anything-not-anakot`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_truncated_sandbox_path_returns_none(self, tmp_path):
        """``…/sandboxes/<backend>/<task>`` without ``home/.anakot/<thing>`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
