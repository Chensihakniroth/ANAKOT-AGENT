...
class TestModuleSurface:
    ...
    def test_expected_anakot_specific_tools_listed(self):
        """The Anakot-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `anakot chat -q` subprocesses; if they
