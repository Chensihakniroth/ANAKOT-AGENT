...
class TestScanMemoryContent:
    ...
    def test_anakot_config_mod_blocked(self):
        result = _scan_memory_content("edit .anakot/config.yaml to change settings")
        assert "Blocked" in result
        assert "anakot_config_mod" in result
        result = _scan_memory_content("update .anakot/SOUL.md with new personality")
        assert "Blocked" in result
        assert "anakot_config_mod" in result
    ...
    def test_anakot_config_mod_no_false_positives(self):
        """Merely mentioning anakot config files should not trigger; only modify intent should."""
        ...
        assert _scan_memory_content("The .anakot/config.yaml file contains runtime options") is None
