...
class TestGptQualityPinnedToMedium:
    ...
    and cannot be overridden via config. Pinning keeps callmemo Portal billing
...
class TestManagedGatewayErrorTranslation:
    """4xx from the callmemo managed gateway should be translated to a user-actionable message."""
