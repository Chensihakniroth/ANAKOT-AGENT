...
def test_get_session_env_default_when_nothing_set(monkeypatch):
    ...
    assert get_session_env("ANAKOT_SESSION_PLATFORM") == ""
    assert get_session_env("ANAKOT_SESSION_PLATFORM", "fallback") == "fallback"
...
def test_session_key_set_via_contextvars(monkeypatch):
    """set_session_vars should set ANAKOT_SESSION_KEY via contextvars."""
    ...
    assert get_session_env("ANAKOT_SESSION_KEY") == "tg:-1001:17585"
