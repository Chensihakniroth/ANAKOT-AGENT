...
class TestBuildJobPromptScansSkillContent:
    def test_clean_skill_builds_normally(self, cron_env):
        ...
        _plant_skill(anakot_home, "news-digest", "Fetch the top 5 headlines and summarize.")
    ...
    def test_skill_with_invisible_unicode_sanitized_not_blocked(self, cron_env):
        ...
        _plant_skill(anakot_home, "zwsp-skill", "clean looking\u200bskill content")
    ...
    def test_skill_bundle_in_job_skills_loads_referenced_skills(self, cron_env):
        anakot_home, scheduler = cron_env
        _plant_skill(anakot_home, "alpha-skill", "Alpha guidance for the cron task.")
        _plant_skill(anakot_home, "beta-skill", "Beta guidance for the cron task.")
        _plant_bundle(
            anakot_home,
            "article-pipeline",
