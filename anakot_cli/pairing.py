...
Usage:
    anakot pairing list              # Show all pending + approved users
    anakot pairing approve <platform> <code>  # Approve a pairing code
    anakot pairing revoke <platform> <user_id> # Revoke user access
    anakot pairing clear-pending     # Clear all expired/pending codes
"""
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.anakot/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'anakot pairing list' to see pending codes.\n")
