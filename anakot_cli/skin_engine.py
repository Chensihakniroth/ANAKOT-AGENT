"""Anakot CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.anakot/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from anakot_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Anakot Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.anakot/skins/
...
Drop a YAML file in ``~/.anakot/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_hero: str = ""    # Rich-markup hero art (replaces ANAKOT_ICON)
...
[dim #3A5568]                  arc reactor online[/]""",
    ...
    "opencode": {
        "name": "opencode",
        "description": "OpenCode CLI — warm peach, dark charcoal, violet accent",
        "colors": {
            # Palette distilled from the opencode CLI default theme
            # (packages/tui/src/theme/assets/opencode.json):
            #   primary #fab283 (warm peach), secondary #5c9cf5 (blue),
            #   accent #9d7cd8 (violet), text #eeeeee, muted #808080,
            #   backgrounds #0a0a0a/#141414/#1e1e1e, borders #3c3c3c..#606060,
            #   diff added #4fd6be / removed #c53b53.
            "banner_border": "#5a5a5a",
            "banner_title": "#fab283",
            "banner_accent": "#9d7cd8",
            "banner_dim": "#9a9a9a",
            "banner_text": "#eeeeee",
            "ui_accent": "#fab283",
            "ui_label": "#5c9cf5",
        ...
        "spinner": {
            ...
            "thinking_faces": ["(fab)", "(◇)", "(∧)", "(⌁)", "(+)"],
            "thinking_verbs": [
                "queuing the request", "shading tokens", "rounding corners",
                "twiddling the prompt", "blinking the cursor", "holding the frame",
                "flattening the tree", "measuring context",
            ],
            "wings": [
                ["⟪◆", "◆⟫"],
                ["⟪◇", "◇⟫"],
        ...
        "branding": {
            "agent_name": "Anakot Agent",
            "welcome": "OpenCode-style session active. Type your message or /help for commands.",
            "goodbye": "Goodbye! ◆",
            "response_label": " ◆ Anakot ",
            "prompt_symbol": "❯",
            "help_header": "◆ Available Commands",
