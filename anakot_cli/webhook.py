...
Subscriptions persist to ~/.anakot/webhook_subscriptions.json and are
...
def _subscriptions_path() -> Path:
    return _anakot_home() / _SUBSCRIPTIONS_FILENAME
...
def _cmd_subscribe(args):
    ...
    print(f"  The gateway must be running to receive events (anakot gateway run).\n")
