...
Visual styling mirrors the callmemo design system (the
...
``tests/anakot_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<body>
<main>
  <div class="brand">callmemo<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
