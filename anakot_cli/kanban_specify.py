...
Used by ``anakot kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``anakot_cli/goals.py`` — same aux
...
ANAKOT_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    int(os.getenv("ANAKOT_KANBAN_SPECIFY_MAX_TOKENS", "6000")),
)
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=ANAKOT_KANBAN_SPECIFY_MAX_TOKENS,
