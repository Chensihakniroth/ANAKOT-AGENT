    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/callmemo/anakot-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/callmemo/anakot-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/callmemo',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/callmemo' },
            { label: 'GitHub Issues', href: 'https://github.com/callmemo/anakot-agent/issues' },
      ...
      copyright: `Built by <a href="https://callmemo.ai">callmemo</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
