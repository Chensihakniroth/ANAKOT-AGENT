...
完整的语音功能集——包括 CLI 麦克风模式、消息中的语音回复以及 Discord 语音频道对话——请参阅 [Voice Mode](/user-guide/features/voice-mode) 和 [Use Voice Mode with Anakot](/guides/use-voice-mode-with-anakot)。
...
在 `~/.anakot/gateway.json` 中配置各平台的覆盖设置：
