...
- **私有 SPI 风险。** Apple 可能在任何 OS 更新中更改 SkyLight 的符号接口。如需在 macOS 版本升级时保持可复现性，请通过 `ANAKOT_CUA_DRIVER_VERSION` 环境变量固定驱动版本。
...
- [通用技能：`macos-computer-use`](https://github.com/callmemo/anakot-agent/blob/main/skills/apple/macos-computer-use/SKILL.md)
