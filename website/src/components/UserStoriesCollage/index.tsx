  ...
  return (
    <div className={styles.wrap}>
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/callmemo/anakot-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/callmemo" target="_blank" rel="noopener noreferrer">
          callmemo Discord
        </a>{' '}
