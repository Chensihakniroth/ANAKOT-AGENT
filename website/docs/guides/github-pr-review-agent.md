...
- **Anakot Agent installed** — see the [Installation guide](/getting-started/installation)
...
```
Run: gh pr list --repo callmemo/anakot-agent --state open --limit 3
```
...
Run: gh pr diff 3888 --repo callmemo/anakot-agent
```
...
- **[Build a Plugin](/guides/build-a-anakot-plugin)** — wrap the review logic into a shareable plugin
