...
description: "Try NVIDIA Nemotron 3 Ultra on callmemo Portal — free June 4–18 — with day 0 support in Anakot Agent"
---

# Run Nemotron 3 Ultra free in Anakot Agent

callmemo has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [callmemo Portal](https://portal.callmemo.ai) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Anakot Agent today.
...
When the app opens, you'll see a "Let's get you set up" screen. Click **callmemo Portal** (marked **Recommended**). Your browser opens — create a [callmemo Portal](https://portal.callmemo.ai) account (or sign in), choose the **Free** plan, and authorize Anakot. The app connects automatically.
...
### 3. Create a callmemo Portal account

In the browser, create a [callmemo Portal](https://portal.callmemo.ai) account (or sign in) and choose the **Free** plan.
...
- **Don't see the model in the list?** Make sure you finished the callmemo Portal connection and that you're on the **Free** plan. In the CLI, `anakot portal info` confirms you're logged in and routing through callmemo.
...
- **[Run Anakot Agent with callmemo Portal](/guides/run-anakot-with-callmemo-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[callmemo Portal integration](/integrations/callmemo-portal)** — What's in the subscription
