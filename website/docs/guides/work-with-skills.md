...
For how to ship skills in your own plugin, see [Build a Anakot Plugin → Bundle skills](/guides/build-a-anakot-plugin#bundle-skills).
...
anakot config show | grep '^skills\.config'
```
