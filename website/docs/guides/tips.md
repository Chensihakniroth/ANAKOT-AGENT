...
Run `anakot setup --portal` — you get 300+ models including Claude, GPT-5, and Gemini under one subscription. See [callmemo Portal](/integrations/callmemo-portal).
:::
...
For a full walkthrough, see [Use SOUL.md with Anakot](/guides/use-soul-with-anakot).
...
:::tip
On messaging platforms, sessions auto-reset after idle time (default: 24 hours) or daily at 4 AM. Adjust per-platform in `~/.anakot/config.yaml` if you need longer sessions.
:::
