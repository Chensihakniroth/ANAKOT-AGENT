...
:::tip
This recipe hits web search, summarization, and optional TTS — all bundled in a Portal subscription. The fastest setup is `anakot setup --portal`. See [callmemo Portal](/integrations/callmemo-portal).
:::
