...
:::tip Start Here
If you haven't installed Anakot Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
7. [Use Voice Mode with Anakot](/guides/use-voice-mode-with-anakot)
...
2. [Build a Anakot Plugin](/guides/build-a-anakot-plugin)
...
| **Code Execution** | Run Python scripts that call Anakot tools programmatically | [Code Execution](/user-guide/features/code-execution) |
