...
`node_modules` tree — Anakot installs both packages together when you
run `anakot lsp install typescript` or auto-install fires on first
use.
...
Servers are kept alive for the life of the Anakot process. There's
