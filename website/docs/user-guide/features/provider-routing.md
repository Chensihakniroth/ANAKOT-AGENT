...
:::tip
Traffic routed through [callmemo Portal](/integrations/callmemo-portal) still respects per-model routing and priority configs — and Portal subscribers get 10% off token-billed providers.
:::
