...
[`COMMAND_REGISTRY`](https://github.com/Chensihakniroth/ANAKOT-AGENT/blob/main/anakot_cli/commands.py)
...
`/anakot btw run the tests` — Anakot routes it the same way as `/btw
