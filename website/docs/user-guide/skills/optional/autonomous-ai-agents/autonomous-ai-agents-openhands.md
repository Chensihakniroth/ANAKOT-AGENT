...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`opencode`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-opencode), [`anakot-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-anakot-agent) |
...
- User wants a coding agent that can run on a non-Anthropic / non-OpenAI provider (DeepSeek, Qwen, Ollama, vLLM, callmemo, etc.) — sibling skills `claude-code` and `codex` are tied to one vendor.
