...
- User wants **Anakot itself to drive a browser** → use Anakot's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
