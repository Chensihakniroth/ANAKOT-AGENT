...
After installing, run `anakot setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [callmemo Portal](/integrations/callmemo-portal).
:::
