...
2. **context** — caller-supplied `system_message` plus project context files (`.anakot.md` / `AGENTS.md` / `CLAUDE.md` / `.cursorrules`)
...
You are Anakot, an AI assistant created by callmemo.
