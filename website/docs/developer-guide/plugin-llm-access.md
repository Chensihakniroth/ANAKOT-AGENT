...
[`anakot-example-plugins`](https://github.com/callmemo/anakot-example-plugins/tree/main/plugin-llm-example)
...
[`plugin-llm-async-example`](https://github.com/callmemo/anakot-example-plugins/tree/main/plugin-llm-async-example)
in the same repo.
...
* **Fallback chain.** If the user's primary provider 5xxs or 429s,
  the request goes through Anakot's usual aggregator-aware fallback
...
* Implementation: [`agent/plugin_llm.py`](https://github.com/Chensihakniroth/ANAKOT-AGENT/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/Chensihakniroth/ANAKOT-AGENT/blob/main/tests/agent/test_plugin_llm.py)
* Reference plugins (companion repo):
  * [`plugin-llm-example`](https://github.com/callmemo/anakot-example-plugins/tree/main/plugin-llm-example) — sync structured extraction with image input
  * [`plugin-llm-async-example`](https://github.com/callmemo/anakot-example-plugins/tree/main/plugin-llm-async-example) — async with `asyncio.gather()`
