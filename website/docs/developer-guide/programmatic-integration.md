...
anakot acp --bootstrap      # print install snippet for an ACP-capable IDE
```
...
Every command in the Pi-mono RPC spec ([issue #360](https://github.com/Chensihakniroth/ANAKOT-AGENT/issues/360)) has a TUI-gateway equivalent:
...
- **API server:** include a `model` field in the request body or set `X-Anakot-Model`
