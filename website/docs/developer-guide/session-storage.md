...
Default path: `~/.anakot/state.db`

This is derived from `anakot_constants.get_anakot_home()` which resolves to
`~/.anakot/` by default, or the value of `ANAKOT_HOME` environment variable.
