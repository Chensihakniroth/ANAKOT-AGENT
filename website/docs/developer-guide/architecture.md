...
├── cli.py                    # AnakotCLI — interactive terminal UI (large file)
...
│   ├── main.py               # Entry point — all `anakot` subcommands (large file)
...
→ [Plugin Guide](/guides/build-a-anakot-plugin), [Memory Provider Plugin](./memory-provider-plugin.md)
