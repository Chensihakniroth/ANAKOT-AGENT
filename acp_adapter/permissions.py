...
# Maps ACP permission option ids to Anakot approval result strings.
...
def _build_permission_options(*, allow_permanent: bool) -> list[PermissionOption]:
    ...
    options = [
        ...
        PermissionOption(
            ...
            # hint while keeping Anakot semantics in the option id.
            kind="allow_always",
...
def _map_outcome_to_anakot(outcome: object, *, allowed_option_ids: set[str]) -> str:
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_ANAKOT.get(option_id, "deny")
...
def make_approval_callback(
    ...
    """
    Return a Anakot-compatible approval callback that bridges to ACP.
