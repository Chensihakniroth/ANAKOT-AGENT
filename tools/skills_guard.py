...
Trust levels:
  - builtin:   Ships with Anakot. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.anakot/\.env|\~/\.anakot/\.env',
     "anakot_env_access", "critical", "exfiltration",
     "directly references Anakot secrets file"),
    ...
    (r'\.anakot/config\.yaml|\.anakot/SOUL\.md',
     "anakot_config_mod", "critical", "persistence",
     "references Anakot configuration files directly"),
...
# scan. `.skillignore` is the Anakot-native name; `.clawhubignore` is honored
