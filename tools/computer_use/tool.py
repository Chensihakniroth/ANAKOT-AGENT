...
# regardless of approval level (e.g. logout kills the session Anakot runs in).
_BLOCKED_KEY_COMBOS = {
...
def handle_computer_use(args: Dict[str, Any], **kwargs) -> Any:
    ...
    try:
        ...
        return json.dumps({
            ...
            "hint": "Run `anakot tools` and enable Computer Use to install cua-driver.",
        })
...
def _route_capture_through_aux_vision(
    ...
    The captured base64 PNG is materialised to ``$ANAKOT_HOME/cache/vision/``
    ...
    try:
        ...
        cache_dir = get_anakot_dir("cache/vision", "temp_vision_images")
