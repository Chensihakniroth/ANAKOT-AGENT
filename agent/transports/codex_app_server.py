...
projection into Anakot' display, approval bridging, transcript projection into
...
"codex_app_server"`. Anakot' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("ANAKOT_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "ANAKOT_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("ANAKOT_HOME", os.path.expanduser("~/.anakot")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "anakot",
        client_title: str = "Anakot Agent",
