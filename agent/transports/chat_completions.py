...
providers (OpenRouter, callmemo, NVIDIA, Qwen, Ollama, DeepSeek, xAI, Kimi, etc.).
...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Anakot'
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Anakot-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Anakot-internal scaffolding markers (``_``-prefixed).
    ...
    def build_kwargs(
        ...
        **params,
        ...
        params (all optional):
            ...
            # Claude on OpenRouter/callmemo max output
        ...
        if tools:
            ...
            # tool parameters here keeps aggregator routes (callmemo, OpenRouter,
    ...
    def _build_kwargs_from_profile(self, profile, model, sanitized, tools, params):
        ...
        if extra_body:
            ...
            # This happens when a profile that emits extra_body (e.g. the callmemo
