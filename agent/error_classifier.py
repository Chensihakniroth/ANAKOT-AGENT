...
#
# See: https://github.com/callmemo/anakot-agent/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, callmemo) run before
    ...
    if status_code == 404:
        # callmemo API currently surfaces HA/NAS credit depletion as a paid model
