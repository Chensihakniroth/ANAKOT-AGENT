...
This adapter lets Anakot use the ``google-gemini-cli`` provider as if it were
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "anakot-agent (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/anakot",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a Anakot issue). Try a different Gemini model or set a "
        ...
        message = (
            ...
            f"retired. Check anakot_cli/models.py for the current list."
        )
    elif err_message:
