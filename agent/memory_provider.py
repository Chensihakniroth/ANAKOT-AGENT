...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - anakot_home (str): The active ANAKOT_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.anakot``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "anakot").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'anakot memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], anakot_home: str) -> None:
        ...
        Called by 'anakot memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``anakot_home`` is the active ANAKOT_HOME directory path.
