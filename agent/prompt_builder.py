...
SELF_MODIFICATION_GUARD = (
    ...
    "- Do NOT read any files inside the anakot-agent repo\n"
    "- Do NOT search or grep for files inside the anakot-agent repo\n"
    "- Do NOT write, patch, or delete any file inside the anakot-agent repo\n"
    "- Do NOT execute any terminal commands that touch the anakot-agent repo\n"
