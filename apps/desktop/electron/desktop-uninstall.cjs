...
function resolveRemovableAppPath(execPath, platform, env = {}) {
  ...
  if (platform === 'win32') {
    ...
    if (/[\\/]Anakot$/i.test(dir) || /[\\/]anakot-desktop$/i.test(dir)) return dir
    return null
  }
 ...
 */
function buildWindowsCleanupScript({ desktopPid, pythonExe, pythonPath, agentRoot, uninstallArgs, appPath, anakotHome }) {
