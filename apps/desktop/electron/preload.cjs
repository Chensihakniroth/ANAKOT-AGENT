...
contextBridge.exposeInMainWorld('anakotDesktop', {
  ...
  gitPush: cwd => ipcRenderer.invoke('anakot:git:push', { cwd }),
  gitCommitAmend: (cwd, message) => ipcRenderer.invoke('anakot:git:commit-amend', { cwd, message }),
  gitDiff: (cwd, file) => ipcRenderer.invoke('anakot:git:diff', { cwd, file }),
  gitDiffStats: cwd => ipcRenderer.invoke('anakot:git:diff-stats', { cwd }),
  gitStagedDiff: cwd => ipcRenderer.invoke('anakot:git:staged-diff', { cwd }),
  gitShipInfo: cwd => ipcRenderer.invoke('anakot:git:ship-info', { cwd }),
  gitCreatePr: (cwd, title, body) => ipcRenderer.invoke('anakot:git:create-pr', { cwd, title, body }),
