...
export const PromptInput = React.forwardRef<HTMLDivElement, PromptInputProps>(
  (
    ...
    // Keep textarea auto-resize on value/text change
    useEffect(() => {
        ...
        >
          ...
          >
            ...
            <textarea
              ...
              className={cn(
                "prompt-scrollbar absolute top-0 inset-x-0 z-[1] w-full resize-none bg-transparent pl-4 pr-12 py-3.5 text-sm leading-[22px] text-foreground outline-none placeholder:text-(--ui-text-tertiary)/80 cursor-text",
