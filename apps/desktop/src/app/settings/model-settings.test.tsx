...
beforeEach(() => {
  ...
  getGlobalModelOptions.mockResolvedValue({
    providers: [
      { name: 'callmemo', slug: 'nous', models: ['anakot-4', 'anakot-4-mini'], authenticated: true },
  ...
  setModelAssignment.mockResolvedValue({ provider: 'nous', model: 'anakot-4', gateway_tools: [] })
...
describe('ModelSettings', () => {
  it('loads the current main model and lists the full provider universe', async () => {
    ...
    // "callmemo" shows in both the trigger and the open list; the unconfigured
