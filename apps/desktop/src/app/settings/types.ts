...
export type SettingsView = 'about' | 'browserProfile' | 'discord' | 'freeModels' | 'gateway' | 'keys' | 'mcp' | 'notifications' | 'pets' | 'providers' | 'sessions' | 'toolsets' | 'webhooks' | `config:${string}`
