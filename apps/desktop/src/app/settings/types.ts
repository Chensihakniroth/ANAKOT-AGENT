...
export type SettingsView = 'about' | 'browserProfile' | 'customEndpoints' | 'discord' | 'freeModels' | 'gateway' | 'keybinds' | 'keys' | 'mcp' | 'notifications' | 'pets' | 'providers' | 'sessions' | 'toolsets' | 'webhooks' | `config:${string}`
