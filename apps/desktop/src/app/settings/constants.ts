...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  {
    ...
    description: 'callmemo Portal — hosted Anakot & locally-trained models',
  ...
  { prefix: 'ANAKOT_GEMINI_', name: 'Gemini', priority: 4 },
  {
    prefix: 'DEEPSEEK_',
    name: 'DeepSeek',
...
export const FIELD_DESCRIPTIONS: Record<string, string> = defineFieldCopy({
  ...
  timezone: 'Used when Anakot needs local time context. Blank uses the system timezone.',
  agent: {
