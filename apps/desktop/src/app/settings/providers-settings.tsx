...
import { listOAuthProviders } from '@/anakot'
...
function OAuthPicker({ onWantApiKey, providers }: { onWantApiKey: () => void; providers: OAuthProvider[] }) {
  ...
  // Split providers into connected and unconnected; hide unconnected behind
  // a disclosure so the page leads with what's set up.
