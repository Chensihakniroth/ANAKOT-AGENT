...
export const titlebarHeaderBaseClass =
  'relative z-3 flex h-(--titlebar-height) shrink-0 items-center justify-start gap-3 border-b border-(--ui-stroke-tertiary) bg-(--ui-chat-surface-background) px-[max(0.75rem,var(--titlebar-content-inset,0rem))] [-webkit-app-region:drag] [&_*]:[-webkit-app-region:no-drag]'
