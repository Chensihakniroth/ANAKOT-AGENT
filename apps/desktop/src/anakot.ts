...
// the call; each pooled backend already has its own ANAKOT_HOME, so no backend
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return window.anakotDesktop.api<SessionSearchResponse>({
...
export function getSessionMessages(id: string, profile?: string | null): Promise<SessionMessagesResponse> {
  ...
  return window.anakotDesktop.api<SessionMessagesResponse>({
...
export function getGlobalModelInfo(): Promise<ModelInfoResponse> {
  return window.anakotDesktop.api<ModelInfoResponse>({
    ...profileScoped(),
    path: '/api/model/info'
  })
}
...
export function getStatus(): Promise<StatusResponse> {
  return window.anakotDesktop.api<StatusResponse>({
    path: '/api/status'
  })
}
...
export function getLogs(params: {
  ...
  return window.anakotDesktop.api<LogsResponse>({
    ...profileScoped(),
    path: suffix ? `/api/logs?${suffix}` : '/api/logs'
  })
}

export function getAnakotConfig(): Promise<AnakotConfig> {
  return window.anakotDesktop.api<AnakotConfig>({
    ...profileScoped(),
    path: '/api/config'
  })
}

export function getAnakotConfigRecord(): Promise<AnakotConfigRecord> {
...
export function getAnakotConfigSchema(): Promise<ConfigSchemaResponse> {
  return window.anakotDesktop.api<ConfigSchemaResponse>({
    ...profileScoped(),
    path: '/api/config/schema'
  })
}

export function saveAnakotConfig(config: AnakotConfigRecord): Promise<{ ok: boolean }> {
  return window.anakotDesktop.api<{ ok: boolean }>({
    ...profileScoped(),
    path: '/api/config',
    method: 'PUT',
...
export function getEnvVars(): Promise<Record<string, EnvVarInfo>> {
  return window.anakotDesktop.api<Record<string, EnvVarInfo>>({
    ...profileScoped(),
    path: '/api/env'
  })
}
...
export function validateProviderCredential(
  ...
  return window.anakotDesktop.api<{ ok: boolean; reachable: boolean; message: string; models?: string[] }>({
    ...profileScoped(),
...
export function listOAuthProviders(): Promise<OAuthProvidersResponse> {
  return window.anakotDesktop.api<OAuthProvidersResponse>({
    ...profileScoped(),
...
export function submitOAuthCode(providerId: string, sessionId: string, code: string): Promise<OAuthSubmitResponse> {
  return window.anakotDesktop.api<OAuthSubmitResponse>({
    ...profileScoped(),
...
export function selectToolsetProvider(
  ...
  return window.anakotDesktop.api<{ ok: boolean; name: string; provider: string }>({
    ...profileScoped(),
...
export function getMessagingPlatforms(): Promise<MessagingPlatformsResponse> {
  return window.anakotDesktop.api<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return window.anakotDesktop.api<{ ok: boolean; platform: string }>({
...
export function testMessagingPlatform(platformId: string): Promise<MessagingPlatformTestResponse> {
  return window.anakotDesktop.api<MessagingPlatformTestResponse>({
...
export function getCronJobs(): Promise<CronJob[]> {
  return window.anakotDesktop.api<CronJob[]>({
    path: '/api/cron/jobs'
  })
}
...
export function getProfiles(): Promise<ProfilesResponse> {
  return window.anakotDesktop.api<ProfilesResponse>({
    path: '/api/profiles'
  })
}

export function createProfile(body: ProfileCreatePayload): Promise<{ name: string; ok: boolean; path: string }> {
  return window.anakotDesktop.api<{ name: string; ok: boolean; path: string }>({
    path: '/api/profiles',
    method: 'POST',
    body
  })
...
export function deleteProfile(name: string): Promise<{ ok: boolean; path: string }> {
  return window.anakotDesktop.api<{ ok: boolean; path: string }>({
    path: `/api/profiles/${encodeURIComponent(name)}`,
    method: 'DELETE'
  })
}
...
export function getProfileSoul(name: string): Promise<ProfileSoul> {
  return window.anakotDesktop.api<ProfileSoul>({
...
export function getProfileSetupCommand(name: string): Promise<ProfileSetupCommand> {
  return window.anakotDesktop.api<ProfileSetupCommand>({
...
export function getGlobalModelOptions(): Promise<ModelOptionsResponse> {
  return window.anakotDesktop.api<ModelOptionsResponse>({
    ...profileScoped(),
...
export interface RecommendedDefaultModel {
  provider: string
  model: string
  /** True/false for callmemo (free vs paid tier); null for other providers. */
  free_tier: boolean | null
}

// Recommended default model for a freshly-authenticated provider. Mirrors the
// curation `anakot model` does — for callmemo it honors the free/paid tier so a
// free user gets a free model instead of a paid default.
export function getRecommendedDefaultModel(provider: string): Promise<RecommendedDefaultModel> {
  return window.anakotDesktop.api<RecommendedDefaultModel>({
    ...profileScoped(),
...
export function setGlobalModel(
  ...
  return window.anakotDesktop.api<{ ok: boolean; provider: string; model: string }>({
    ...profileScoped(),
    path: '/api/model/set',
    method: 'POST',
    body: {
...
export function getAuxiliaryModels(): Promise<AuxiliaryModelsResponse> {
  return window.anakotDesktop.api<AuxiliaryModelsResponse>({
    ...profileScoped(),
...
export function transcribeAudio(dataUrl: string, mimeType?: string): Promise<AudioTranscriptionResponse> {
  return window.anakotDesktop.api<AudioTranscriptionResponse>({
...
export function speakText(text: string): Promise<AudioSpeakResponse> {
  return window.anakotDesktop.api<AudioSpeakResponse>({
...
export function getElevenLabsVoices(): Promise<ElevenLabsVoicesResponse> {
  return window.anakotDesktop.api<ElevenLabsVoicesResponse>({
