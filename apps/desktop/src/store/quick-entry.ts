 ...
 * app/session/hooks/use-quick-entry-bridge). There is no second submit path and
 * no new gateway RPC.
 *
 ...
 * split as keep-awake.
 *
 * Ported from Hermes Agent (apps/desktop/src/store/quick-entry.ts), hermes→anakot
 * renames applied.
 */
