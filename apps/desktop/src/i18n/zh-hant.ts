...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Anakot Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Anakot 後端，請使用遠端閘道。在下方按設定檔指定各自的遠端主機。',
      appliesTo: '套用至',
      allProfiles: '全部設定檔',
      ...
      envOverrideDesc:
        '取消設定 ANAKOT_DESKTOP_REMOTE_URL 和 ANAKOT_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
    ...
    toolsets: {
      ...
      ready: '就緒',
      nousIncluded: '包含在 callmemo 訂閱中；登入 callmemo Portal 即可啟用。',
  ...
  commandCenter: {
    ...
    goTo: '前往',
    git: 'Git',
    gitSourceControl: '原始碼管理',
    gitStaged: '已暫存',
    gitChanges: '變更',
    gitUntracked: '未追蹤',
    gitNoChanges: '無變更',
    gitNotAGitRepo: '不是 Git 倉庫',
    gitLoadingGit: '正在載入 Git 狀態...',
    gitCommit: '提交',
    gitCommitPlaceholder: '提交訊息',
    gitStageFile: '暫存',
    gitUnstageFile: '取消暫存',
    gitDiscardChanges: '放棄變更',
    gitStageAll: '全部暫存',
  ...
  cron: {
    ...
    emptyDescNew:
      '按 cron 表達式排程一個提示詞。Anakot 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  updates: {
    ...
    applyingBody: 'Anakot 更新程式會在自己的視窗中接管，並在完成後重新開啟 Anakot。',
    applyingClose: 'Anakot 將關閉以套用更新。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    activeDesc:
      '這是一次性設定。Anakot 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `已在瀏覽器中開啟 ${provider}。請在那裡授權 Anakot，連線會自動完成，無需複製或貼上。`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付費 callmemo 訂閱。',
    free: '免費',
    freeTier: '免費層',
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Anakot 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      ...
      stillWorking:
        'Anakot 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Anakot 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
