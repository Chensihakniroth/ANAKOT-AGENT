...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      backgroundExited: 'Anakot background process exited.',
      backgroundExitedDuringStartup: 'Anakot background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Anakot Desktop.',
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.toggleFloatingHud': 'Toggle floating quick actions',
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        ...
        restartHint: 'The backend has been updated. Close and reopen the pet panel to pick up changes.',
        searchPlaceholder: 'Search by name or slug…',
        unreachable: 'The pet gallery could not be reached via the local backend.',
        ...
        countCapped: (cap: number, total: number) => `Showing ${cap} of ${total} pets.`,
        count: (n: number) => `${n} pet${n === 1 ? '' : 's'}`,
        chooseDesc: 'Pick your active pet or toggle the pet display on/off.',
        chooseTitle: 'Pet',
        off: 'Off',
        on: 'On',
        scaleTitle: 'Pet scale',
        scaleDesc: 'Adjust the size of the floating pet.',
        roamTitle: 'Pet roaming',
        roamDesc: 'Let the pet wander around the screen on its own.',
        deleteConfirm: 'Delete',
        deleteBody: 'Deleting is permanent and cannot be undone.',
    ...
    gateway: {
      ...
      intro:
        'Anakot Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Anakot backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      appliesTo: 'Applies to',
      allProfiles: 'All profiles',
      ...
      envOverrideDesc:
        'Unset ANAKOT_DESKTOP_REMOTE_URL and ANAKOT_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Anakot backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Anakot backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Anakot Desktop will reconnect using the saved settings.',
  ...
  commandCenter: {
    ...
    gitNotAGitRepo: 'Not a git repository',
    gitLoadingGit: 'Loading git status...',
    gitCommit: 'Commit',
    gitCommitPlaceholder: 'Commit message',
    gitStageFile: 'Stage',
    gitUnstageFile: 'Unstage',
    gitDiscardChanges: 'Discard Changes',
    gitStageAll: 'Stage All',
    gitCommitHint: 'Ctrl+Enter to commit',
  ...
  updates: {
    ...
    packagedUpdateBody: 'A new version is available. Download it from GitHub to update your installed app.',
    packagedUpdateButton: 'Download from GitHub',
    ...
    applyingBody: 'The Anakot updater will take over in its own window and reopen Anakot when it’s done.',
    applyingClose: 'Anakot will close to apply the update.',
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Anakot CLI or desktop instance is running. Stop any running Anakot instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'Opens your browser to sign in — Anakot connects automatically',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid callmemo subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Anakot inference gateway status',
      agents: 'Agents',
  ...
  prompts: {
    ...
    sudoDesc: 'Anakot needs your sudo password to run a privileged command. It is sent only to your local agent.',
