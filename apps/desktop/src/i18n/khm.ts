// Khmer (khm) translations for the desktop app.
//
...
// desktop-only strings are inherited from `en` rather than left as empty
// strings or raw key paths.
//
// Add new Khmer strings here as translations become available. Keys omitted
// from the overrides object are filled in from English at runtime.
