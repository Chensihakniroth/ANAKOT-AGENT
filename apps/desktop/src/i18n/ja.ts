...
export const ja = defineLocale({
  ...
  settings: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Anakot がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
    ...
    gateway: {
      ...
      intro:
        'Anakot Desktop はデフォルトで独自のローカルゲートウェイを起動します。別のマシンや信頼できるプロキシの背後で既に動作している Anakot バックエンドをこのアプリで制御する場合は、リモートゲートウェイを使用してください。以下でプロファイルを選択して、それぞれのリモートホストを設定します。',
      appliesTo: '適用対象',
      ...
      localDesc: 'ローカルホストでプライベートな Anakot バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
      ...
      remoteUrlDesc: 'リモートダッシュボードバックエンドのベース URL。/anakot などのパスプレフィックスもサポートしています。',
    ...
    toolsets: {
      ...
      ready: '準備完了',
      nousIncluded: 'callmemo サブスクリプションに含まれています。有効にするには callmemo Portal にサインインしてください。',
  ...
  commandCenter: {
    ...
    goTo: '移動',
    git: 'Git',
    gitSourceControl: 'ソースコントロール',
    gitStaged: 'ステージ済み',
    gitChanges: '変更',
    gitUntracked: '未追跡',
    gitNoChanges: '変更なし',
    gitNotAGitRepo: 'Gitリポジトリではありません',
    gitLoadingGit: 'Gitステータスを読み込み中...',
    gitCommit: 'コミット',
    gitCommitPlaceholder: 'コミットメッセージ',
    gitStageFile: 'ステージ',
    gitUnstageFile: 'ステージ解除',
    gitDiscardChanges: '変更を破棄',
    gitStageAll: 'すべてステージ',
    gitCommitHint: 'Ctrl+Enterでコミット',
  ...
  updates: {
    ...
    applyingBody: 'Anakot アップデーターが独自のウィンドウで引き継ぎ、完了後に Anakot を再度開きます。',
    applyingClose: 'Anakot は更新を適用するために閉じます。',
  ...
  onboarding: {
    ...
    flowSubtitles: {
      ...
      loopback: 'サインインのためブラウザーを開きます — Anakot が自動接続します',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro モデルには有料の callmemo サブスクリプションが必要です。',
    free: '無料',
    freeTier: '無料プラン',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Anakot 推論ゲートウェイのステータス',
      agents: 'エージェント',
  ...
  prompts: {
    ...
    sudoTitle: '管理者パスワード',
    sudoDesc:
      'Anakot は特権コマンドを実行するために sudo パスワードが必要です。ローカルエージェントにのみ送信されます。',
