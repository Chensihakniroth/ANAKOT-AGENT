...
export const zh: Translations = {
  ...
  commandCenter: {
    ...
    generatePet: {
      genericError: '无法生成宠物。请重试。',
      backgroundHint: '请稍等——请求仍在运行中。某些提供商会需要一些时间。',
      slowProviderHint: '这可能需要一些时间。提供商正在处理。',
      title: '生成宠物',
      spawning: '正在生成...',
      hatched: '已孵化！',
      placeholder: '描述你想要的宠物...',
      generate: '生成',
      staleBackend: '后端已更新，请关闭并重新打开覆盖层。',
      referenceImageTooLarge: '参考图片太大。',
      referenceImageInvalid: '参考图片无效。',
      referenceImageTaken: '已添加参考图片。',
      remix: '重新混搭',
      remixConfirmBody: '这将替换所有当前草稿。是否继续？',
      remixConfirmTitle: '重新混搭宠物',
      namePlaceholder: '输入名称',
      startOver: '重新开始',
      adopt: '领养',
      generating: '正在生成...',
      hatch: '孵化',
      hatchRow: (state, done, total) => `孵化中... ${done}/${total}（${state}）`,
      hatchComposing: '正在合成你的宠物…',
      hatchSaving: '正在保存你的宠物…',
      hatchingSub: '你的宠物正在生成中。这可能需要一点时间。'
    },
    pets: {
      title: '宠物',
      loading: '加载宠物中...',
