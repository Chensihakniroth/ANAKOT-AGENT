 ...
 *   - The hole follows driver.js's OWN animated rect, rather than the target's
 *     static box, so the blur travels with the cutout between steps instead of
 *     jumping ahead.
 *
 * App surface only — a preview guest page keeps driver.js's stock look.
 */

/** Matches the dialog overlay's scrim treatment. */
const FEATHER_PX = 12
