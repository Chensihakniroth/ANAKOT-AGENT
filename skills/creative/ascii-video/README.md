...
Built for [Anakot Agent](https://github.com/callmemo/anakot-agent). Usable in any coding agent. Canonical source lives here; synced to [`callmemo/anakot-agent/skills/creative/ascii-video`](https://github.com/callmemo/anakot-agent/tree/main/skills/creative/ascii-video) via PR.
