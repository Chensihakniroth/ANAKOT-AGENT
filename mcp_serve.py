"""
Anakot MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Anakot-specific extra)

Usage:
    anakot mcp serve
    anakot mcp serve --verbose
...
class EventBridge:
    ...
    This is the Anakot equivalent of OpenClaw's WebSocket gateway bridge.
