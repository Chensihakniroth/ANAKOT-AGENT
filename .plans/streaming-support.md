# Streaming LLM Response Support for Anakot Agent
...
```
ANAKOT_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ANAKOT_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `anakot_cli/config.py` | 1 | +streaming config defaults |
