...
A runner that uses Anakot-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Anakot-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Anakot-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Anakot format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Anakot-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Anakot-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Anakot Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Anakot-Agent's built-in execution environments
    and outputs trajectories in Anakot-Agent format.
    """
    ...
    def _convert_to_anakot_format(
        ...
        """
        Convert internal message format to Anakot trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Anakot trajectory format
        trajectory = self._convert_to_anakot_format(messages, task, completed)
