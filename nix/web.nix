# nix/web.nix — Anakot Web Dashboard (Vite/React) frontend build
{ pkgs, anakotNpmLib, ... }:
let
  npm = anakotNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "anakot-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../anakot_cli/web_dist for the
