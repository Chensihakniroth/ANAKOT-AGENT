...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      anakotNpmLib = self'.packages.default.passthru.anakotNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. anakot-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Anakot Agent dev shell"
          ${combinedNonNpm}
          ${anakotNpmLib.mkNpmDevShellHook npmPackageJsonPaths fixLockfilesExe}
          echo "Ready. Run 'anakot' to start."
        '';
      };
    };
}
