...
Config: ~/.anakot/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.anakot/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_anakot_home()`` helper (ANAKOT_HOME-aware and
