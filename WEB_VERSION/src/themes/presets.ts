...
/**
 * Night Owl — inspired by Sarah Drasner's VS Code theme. Deep teal/navy
 * background with vibrant, meaningful contrast for reading comprehension.
 */
export const nightOwlTheme: DesktopTheme = {
  name: 'night-owl',
  label: 'Night Owl',
  description: 'Deep teal dark with vibrant accents — for the night owls out there',
  colors: {
    background: '#011627',
    foreground: '#d6deeb',
    card: '#0b2942',
    ...
    destructive: '#ef5350',
    destructiveForeground: '#ffffff',
    sidebarBackground: '#01111d',
    sidebarBorder: '#0b2942',
    userBubble: '#0b2942',
    userBubbleBorder: '#1d3b53'
  },
  typography: {
...
/** Warm crimson and bronze — forge vibes. */
export const coffeeTheme: DesktopTheme = {
  name: 'coffee',
  label: 'Coffee',
  description: 'Warm crimson and bronze — rich coffee tones',
  colors: {
    background: '#160800',
    foreground: '#ffd8b0',
    card: '#1e0e04',
...
/** Neon green on black — matrix terminal aesthetic. */
export const theMatrixTheme: DesktopTheme = {
  name: 'the-matrix',
  label: 'The Matrix',
  description: 'Neon green on black — digital rain vibes',
  colors: {
    background: '#000a00',
    foreground: '#00ff41',
    card: '#001200',
...
/** Cool slate blue for developers. */
export const dimTheme: DesktopTheme = {
  name: 'dim',
  label: 'Dim',
  description: 'Cool slate blue — muted and focused',
  colors: {
    background: '#0d1117',
    foreground: '#c9d1d9',
    card: '#161b22',
