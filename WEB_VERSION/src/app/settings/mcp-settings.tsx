...
import { getAnakotConfigRecord, type AnakotGateway, saveAnakotConfig } from '@/anakot'
...
function getServers(config: AnakotConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveAnakotConfig(nextConfig)
