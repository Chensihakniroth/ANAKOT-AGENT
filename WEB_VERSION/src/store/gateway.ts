import type { ConnectionState, GatewayEvent } from '@anakot/shared'
...
export const $gateway = atom<AnakotGateway | null>(null)
...
let primaryGateway: AnakotGateway | null = null
...
export async function ensureActiveGatewayOpen(): Promise<AnakotGateway | null> {
  if (activeKey === primaryProfile) {
    return primaryGateway
  }
